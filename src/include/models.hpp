...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(89, 89, "end", "model_dcpo");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "rob", "int", context__.to_vec());
            rob = int(0);
            vals_i__ = context__.vals_i("rob");
            pos__ = 0;
            rob = vals_i__[pos__++];
            context__.validate_dims("data initialization", "c_a", "int", context__.to_vec());
            c_a = int(0);
            vals_i__ = context__.vals_i("c_a");
            pos__ = 0;
            c_a = vals_i__[pos__++];
            ...
            for (int k0__ = 0; k0__ < R; ++k0__) {
                ...
                check_less_or_equal(function__,"rq[k0__]",rq[k0__],R);
            }
            for (int k0__ = 0; k0__ < R; ++k0__) {
                check_greater_or_equal(function__,"rcp[k0__]",rcp[k0__],1);
                check_less_or_equal(function__,"rcp[k0__]",rcp[k0__],R);
            }
            for (int k0__ = 0; k0__ < N; ++k0__) {
            ...
            check_greater_or_equal(function__,"rob",rob,0);
            check_less_or_equal(function__,"rob",rob,1);
            check_greater_or_equal(function__,"c_a",c_a,0);
            check_less_or_equal(function__,"c_a",c_a,1);
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int r = 1; r <= R; ++r) {
                ...
                if (as_bool(logical_gt(r,1))) {

                    if (as_bool(logical_eq(get_base1(rq,r,"rq",1),get_base1(rq,(r - 1),"rq",1)))) {

                        stan::math::assign(get_base1_lhs(beta,r,"beta",1), (get_base1(beta,(r - 1),"beta",1) + exp(get_base1(beta,r,"beta",1))));
                        if (as_bool(logical_eq(c_a,1))) {

                            stan::math::assign(get_base1_lhs(alpha,r,"alpha",1), get_base1(alpha,(r - 1),"alpha",1));
                        }
                    }
                }
            }
            ...
            if (as_bool(logical_eq(rob,1))) {

                lp_accum__.add(student_t_log<propto__>(theta_raw, 10, 0, 1));
            } else {
