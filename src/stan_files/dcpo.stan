...
parameters{
  ...
  real<lower=0> sd_delta;	            // question-country intercept variation
...
transformed parameters{
  ...
  eta = inv_logit((raw_theta_tt_kk - beta[qq] + delta[pp]) ./ sqrt(sigma_tt_kk + square(alpha[qq])));  // fitted values model
