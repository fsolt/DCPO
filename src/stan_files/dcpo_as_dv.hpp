...
namespace model_dcpo_as_dv_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_dcpo_as_dv");
    reader.add_event(132, 132, "end", "model_dcpo_as_dv");
    return reader;
}

template <typename T0__>
Eigen::Matrix<typename boost::math::tools::promote_args<T0__>::type, Eigen::Dynamic,Eigen::Dynamic>
obtain_adjustments(const Eigen::Matrix<T0__, Eigen::Dynamic,Eigen::Dynamic>& W, std::ostream* pstream__) {
    ...
    try {
        ...
        fun_scalar_t__ min_w;
        (void) min_w;  // dummy to suppress unused var warning

        stan::math::initialize(min_w, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(min_w,DUMMY_VAR__);
        current_statement_begin__ = 6;
        fun_scalar_t__ max_w;
        (void) max_w;  // dummy to suppress unused var warning

        stan::math::initialize(max_w, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(max_w,DUMMY_VAR__);
        current_statement_begin__ = 7;
        int minmax_count(0);
        (void) minmax_count;  // dummy to suppress unused var warning

        stan::math::fill(minmax_count, std::numeric_limits<int>::min());
        current_statement_begin__ = 8;
        validate_non_negative_index("adj", "2", 2);
        validate_non_negative_index("adj", "cols(W)", cols(W));
        Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  adj(static_cast<Eigen::VectorXd::Index>(2),static_cast<Eigen::VectorXd::Index>(cols(W)));
        (void) adj;  // dummy to suppress unused var warning

        stan::math::initialize(adj, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(adj,DUMMY_VAR__);


        current_statement_begin__ = 9;
        stan::math::assign(get_base1_lhs(adj,1,1,"adj",1), 0);
        current_statement_begin__ = 10;
        stan::math::assign(get_base1_lhs(adj,2,1,"adj",1), 1);
        current_statement_begin__ = 11;
        if (as_bool(logical_gt(cols(W),1))) {

            current_statement_begin__ = 12;
            for (int k = 2; k <= cols(W); ++k) {

                current_statement_begin__ = 13;
                stan::math::assign(min_w, min(stan::model::rvalue(W, stan::model::cons_list(stan::model::index_min_max(1, rows(W)), stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list())), "W")));
                current_statement_begin__ = 14;
                stan::math::assign(max_w, max(stan::model::rvalue(W, stan::model::cons_list(stan::model::index_min_max(1, rows(W)), stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list())), "W")));
                current_statement_begin__ = 15;
                stan::math::assign(minmax_count, 0);
                current_statement_begin__ = 16;
                for (int j = 1; j <= rows(W); ++j) {
                    current_statement_begin__ = 17;
                    stan::math::assign(minmax_count, (primitive_value(logical_eq((minmax_count + get_base1(W,j,k,"W",1)),min_w)) || primitive_value(logical_eq(get_base1(W,j,k,"W",1),max_w))));
                }
                current_statement_begin__ = 18;
                if (as_bool(logical_eq(minmax_count,rows(W)))) {

                    current_statement_begin__ = 19;
                    stan::math::assign(get_base1_lhs(adj,1,k,"adj",1), mean(stan::model::rvalue(W, stan::model::cons_list(stan::model::index_min_max(1, rows(W)), stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list())), "W")));
                    current_statement_begin__ = 20;
                    stan::math::assign(get_base1_lhs(adj,2,k,"adj",1), (max_w - min_w));
                } else {

                    current_statement_begin__ = 22;
                    stan::math::assign(get_base1_lhs(adj,1,k,"adj",1), mean(stan::model::rvalue(W, stan::model::cons_list(stan::model::index_min_max(1, rows(W)), stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list())), "W")));
                    current_statement_begin__ = 23;
                    stan::math::assign(get_base1_lhs(adj,2,k,"adj",1), (sd(stan::model::rvalue(W, stan::model::cons_list(stan::model::index_min_max(1, rows(W)), stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list())), "W")) * 2));
                }
            }
        }
        current_statement_begin__ = 27;
        return stan::math::promote_scalar<fun_return_scalar_t__>(adj);
        }
...
struct obtain_adjustments_functor__ {
    template <typename T0__>
        Eigen::Matrix<typename boost::math::tools::promote_args<T0__>::type, Eigen::Dynamic,Eigen::Dynamic>
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic,Eigen::Dynamic>& W, std::ostream* pstream__) const {
        return obtain_adjustments(W, pstream__);
    }
};

#include <meta_header.hpp>
 class model_dcpo_as_dv : public prob_grad {
private:
    int K;
    int T;
    int Q;
    ...
    matrix_d W_adj;
public:
    model_dcpo_as_dv(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_dcpo_as_dv_namespace::model_dcpo_as_dv";
        ...
        try {
            ...
            validate_non_negative_index("W", "(K * T)", (K * T));
            validate_non_negative_index("W", "V", V);
            context__.validate_dims("data initialization", "W", "matrix_d", context__.to_vec((K * T),V));
            validate_non_negative_index("W", "(K * T)", (K * T));
            validate_non_negative_index("W", "V", V);
            W = matrix_d(static_cast<Eigen::VectorXd::Index>((K * T)),static_cast<Eigen::VectorXd::Index>(V));
            vals_r__ = context__.vals_r("W");
            pos__ = 0;
            size_t W_m_mat_lim__ = (K * T);
            size_t W_n_mat_lim__ = V;
            ...
            validate_non_negative_index("adj", "2", 2);
            validate_non_negative_index("adj", "V", V);
            adj = matrix_d(static_cast<Eigen::VectorXd::Index>(2),static_cast<Eigen::VectorXd::Index>(V));
            stan::math::fill(adj,DUMMY_VAR__);
            current_statement_begin__ = 52;
            validate_non_negative_index("W_adj", "(K * T)", (K * T));
            validate_non_negative_index("W_adj", "V", V);
            W_adj = matrix_d(static_cast<Eigen::VectorXd::Index>((K * T)),static_cast<Eigen::VectorXd::Index>(V));
            stan::math::fill(W_adj,DUMMY_VAR__);

            current_statement_begin__ = 53;
            stan::math::assign(adj, obtain_adjustments(W, pstream__));
            current_statement_begin__ = 54;
            for (int v = 1; v <= V; ++v) {
                current_statement_begin__ = 54;
                for (int kt = 1; kt <= (K * T); ++kt) {
                    current_statement_begin__ = 55;
                    stan::math::assign(get_base1_lhs(W_adj,kt,v,"W_adj",1), ((get_base1(W,kt,v,"W",1) - get_base1(adj,1,v,"adj",1)) / get_base1(adj,2,v,"adj",1)));
                }
            }
            ...
            validate_non_negative_index("lambda_adj", "V", V);
            num_params_r__ += V;
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("lambda_adj")))
            throw std::runtime_error("variable lambda_adj missing");
        vals_r__ = context__.vals_r("lambda_adj");
        pos__ = 0U;
        validate_non_negative_index("lambda_adj", "V", V);
        context__.validate_dims("initialization", "lambda_adj", "vector_d", context__.to_vec(V));
        vector_d lambda_adj(static_cast<Eigen::VectorXd::Index>(V));
        for (int j1__ = 0U; j1__ < V; ++j1__)
            lambda_adj(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_unconstrain(lambda_adj);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable lambda_adj: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > xi;
            size_t dim_xi_0__ = R;
            ...
            Eigen::Matrix<T__,Eigen::Dynamic,1>  lambda_adj;
            (void) lambda_adj;  // dummy to suppress unused var warning
            if (jacobian__)
                lambda_adj = in__.vector_constrain(V,lp__);
            else
                lambda_adj = in__.vector_constrain(V);


            // transformed parameters
            current_statement_begin__ = 69;
            validate_non_negative_index("alpha", "R", R);
            Eigen::Matrix<T__,Eigen::Dynamic,1>  alpha(static_cast<Eigen::VectorXd::Index>(R));
            ...
            Eigen::Matrix<T__,Eigen::Dynamic,1>  beta(static_cast<Eigen::VectorXd::Index>(R));
            ...
            Eigen::Matrix<T__,Eigen::Dynamic,1>  theta(static_cast<Eigen::VectorXd::Index>((K * T)));
            ...
            stan::math::assign(get_base1_lhs(alpha,1,"alpha",1), exp(get_base1(get_base1(xi,1,"xi",1),1,"xi",2)));
            current_statement_begin__ = 74;
            stan::math::assign(get_base1_lhs(beta,1,"beta",1), get_base1(get_base1(xi,1,"xi",1),2,"xi",2));
            current_statement_begin__ = 76;
            for (int r = 2; r <= R; ++r) {

                current_statement_begin__ = 77;
                stan::math::assign(get_base1_lhs(alpha,r,"alpha",1), exp(get_base1(get_base1(xi,r,"xi",1),1,"xi",2)));
                current_statement_begin__ = 78;
                if (as_bool(logical_eq(get_base1(rq,r,"rq",1),get_base1(rq,(r - 1),"rq",1)))) {

                    current_statement_begin__ = 79;
                    stan::math::assign(get_base1_lhs(beta,r,"beta",1), (get_base1(beta,(r - 1),"beta",1) + exp(get_base1(get_base1(xi,r,"xi",1),2,"xi",2))));
                } else {

                    current_statement_begin__ = 81;
                    stan::math::assign(get_base1_lhs(beta,r,"beta",1), get_base1(get_base1(xi,r,"xi",1),2,"xi",2));
                }
            }
            ...
            for (int k = 1; k <= K; ++k) {
                ...
                stan::math::assign(get_base1_lhs(theta,(((k - 1) * T) + 1),"theta",1), get_base1(theta_raw,(((k - 1) * T) + 1),"theta_raw",1));
                current_statement_begin__ = 87;
                for (int t = 2; t <= T; ++t) {

                    current_statement_begin__ = 88;
                    stan::math::assign(get_base1_lhs(theta,(((k - 1) * T) + t),"theta",1), (get_base1(theta,((((k - 1) * T) + t) - 1),"theta",1) + (get_base1(sigma_theta,k,"sigma_theta",1) * get_base1(theta_raw,(((k - 1) * T) + t),"theta_raw",1))));
                }
            }
            ...
            validate_non_negative_index("L_Sigma", "2", 2);
            Eigen::Matrix<T__,Eigen::Dynamic,Eigen::Dynamic>  L_Sigma(static_cast<Eigen::VectorXd::Index>(2),static_cast<Eigen::VectorXd::Index>(2));
            ...
            lp_accum__.add(normal_log<propto__>(sigma_theta, 0, 0.050000000000000003));
            ...
            lp_accum__.add(student_t_log<propto__>(lambda_adj, 3, 0, 1));
            current_statement_begin__ = 108;
            lp_accum__.add(normal_log<propto__>(theta_raw, 0, 1));
            current_statement_begin__ = 111;
            lp_accum__.add(normal_log<propto__>(theta, multiply(W_adj,lambda_adj), 1));
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_dcpo_as_dv_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        vector_d lambda_adj = in__.vector_constrain(V);
            ...
            for (int k_0__ = 0; k_0__ < V; ++k_0__) {
            vars__.push_back(lambda_adj[k_0__]);
            }
        ...
        try {
            current_statement_begin__ = 69;
            validate_non_negative_index("alpha", "R", R);
            vector_d alpha(static_cast<Eigen::VectorXd::Index>(R));
            (void) alpha;  // dummy to suppress unused var warning
            ...
            current_statement_begin__ = 70;
            validate_non_negative_index("beta", "R", R);
            vector_d beta(static_cast<Eigen::VectorXd::Index>(R));
            (void) beta;  // dummy to suppress unused var warning
            ...
            current_statement_begin__ = 71;
            validate_non_negative_index("theta", "(K * T)", (K * T));
            vector_d theta(static_cast<Eigen::VectorXd::Index>((K * T)));
            (void) theta;  // dummy to suppress unused var warning
            ...
            validate_non_negative_index("lambda", "V", V);
            vector_d lambda(static_cast<Eigen::VectorXd::Index>(V));
            ...
            vector_d pred_prob(static_cast<Eigen::VectorXd::Index>(N));
            (void) pred_prob;  // dummy to suppress unused var warning

            stan::math::initialize(pred_prob, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(pred_prob,DUMMY_VAR__);


            current_statement_begin__ = 123;
            stan::model::assign(lambda, 
                        stan::model::cons_list(stan::model::index_min_max(2, V), stan::model::nil_index_list()), 
                        elt_divide(stan::model::rvalue(lambda_adj, stan::model::cons_list(stan::model::index_min_max(2, V), stan::model::nil_index_list()), "lambda_adj"),to_vector(stan::model::rvalue(adj, stan::model::cons_list(stan::model::index_uni(2), stan::model::cons_list(stan::model::index_min_max(2, V), stan::model::nil_index_list())), "adj"))), 
                        "assigning variable lambda");
            current_statement_begin__ = 124;
            stan::math::assign(get_base1_lhs(lambda,1,"lambda",1), (multiply(stan::model::rvalue(W_adj, stan::model::cons_list(stan::model::index_uni(1), stan::model::cons_list(stan::model::index_min_max(1, V), stan::model::nil_index_list())), "W_adj"),stan::model::rvalue(lambda_adj, stan::model::cons_list(stan::model::index_min_max(1, V), stan::model::nil_index_list()), "lambda_adj")) - multiply(stan::model::rvalue(W, stan::model::cons_list(stan::model::index_uni(1), stan::model::cons_list(stan::model::index_min_max(2, V), stan::model::nil_index_list())), "W"),stan::model::rvalue(lambda, stan::model::cons_list(stan::model::index_min_max(2, V), stan::model::nil_index_list()), "lambda"))));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::math::assign(get_base1_lhs(pred_prob,n,"pred_prob",1), inv_logit((get_base1(alpha,get_base1(rr,n,"rr",1),"alpha",1) * (get_base1(theta,get_base1(kktt,n,"kktt",1),"theta",1) - get_base1(beta,get_base1(rr,n,"rr",1),"beta",1)))));
            }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= V; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "lambda_adj" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
...
typedef model_dcpo_as_dv_namespace::model_dcpo_as_dv stan_model;
